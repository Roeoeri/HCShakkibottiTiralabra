...
public class TiraBot implements ChessBot {
    ...
    /**
     * Parsii kahden pelitilanteen välisen erotuksen merkkijonomuotoiseksi UCI
     * siirroksi.
     *
    ...
    /**
     * Tarkistaa, onko jossakin annetussa pelitilanteessa peli ohitse, eli
     * toinen kuninkaista on kaatunut.
     *
     * @param board Pelitilanne jota halutaan tarkastella.
     * @return boolean Palauttaa true, jos jompi kumpi kuninkaista on kaatunut,
     * muutoin false.
     */
     ...
     * @return int Numeerinen arvio sille, miten peli tulee jatkumaan kunkin
     * valkoisen siirron jälkeen. Positiivinen jos peli on valkoisen eduksi,
     * muuten negatiivinen.
     */
     ...
     * @param beta Beta-arvo alphabeta pruningia varten.
     * @return int Numeerinen arvio sille, miten peli tulee jatkumaan kunkin
     * mustan siirron jälkeen. Positiivinen jos peli on valkoisen eduksi, muuten
     * negatiivinen.
     */
    ...
    /**
     * Metodi, joka palauttaa parametrina annetun pelitilanteen lapsista sen
     * jolla on suurin arvo (= Paras siirto valkoiselle).
     *
    ...
    /**
     * Metodi, joka palauttaa parametrina annetun pelitilanteen lapsista sen
     * jolla on pienin arvo (= Paras siirto mustalle).
     *
     * @param board Tarkasteltava pelitilanne.
     * @return Piece[][] Piece[][] Pelitilanne joka seuraa parasta mustaa
     * siirtoa.
     */
    ...
    /**
     * Päivittää tirabotin sisäistä pelilautaa parametrina annetun
     * UCI-merkkijonon mukaisesti.
     *
